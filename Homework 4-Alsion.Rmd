...
cols <- c("Name of what that red dot is supposed to be here" = "tomato2")

scc_rams_plot <- ggplot() +
  geom_point(data = scc_df,
             aes(x = rate, y = scc_sum)) +
  geom_point(data = scc_rams_df, aes(x = rate, y = scc_sum, color = "Name of what that red dot is supposed to be here")) +
