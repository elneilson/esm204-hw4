...
scc_plot <- ggplot(data = scc_df) +
  ...
  labs(x = "Discount rate", y = "Total SCC through 2100")
  theme_minimal() + ggtitle("Impact of discount rates on the SCC")
scc_plot
```
...
scc_rams_plot <- ggplot() +
  ...
  labs(x = "Discount rate", y = "Total SCC through 2100")
  theme_minimal() + ggtitle("New SCC Given the Conditions")
scc_rams_plot
```
